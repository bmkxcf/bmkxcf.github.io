...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&display=swap" rel="stylesheet">
 ...
 <body>
  <!-- Everything visible to the user goes inside the <body> -->
    ...
    <header>
   <!-- This section will later hold your logo, navigation, or banner -->
   <div class="site-logo"> 
    ...
    <ul>
          ...
          <li><a href="content.html">Content</a>
            <ul> 
              <li><a  href="content.html#lesson1">Lesson 1</a></li>
              <li><a  href="content.html#lesson2">Lesson 2</a></li>
              <li><a  href="content.html#lesson3">Lesson 3</a></li> 
            </ul>      
          </li>
...
<figure class="table-figure">
    ...
    <footer>
     <!-- Footer appears at the bottom of the page and usually contains credits or contact info -->
    <div class="footer-item">
      &copy;Kaestner 2026
      </div>
    
    <div class="footer-item">
     <img src="webcontent/email.png" alt="" class="footer-icon">
     kaestnerb@missouri.edu
     </div>
   
     <div class="footer-item">
     <img src="webcontent/phone.png" alt="" class="footer-icon">
     (555) 123‑4567
    </div>
